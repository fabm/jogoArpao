...
public class JBola extends JComponent implements
    ...
    public JBola(TipoBola tipo) {
        ...
        tamanho = new Dimension(
                imagemBola.getBI().getWidth(),
                imagemBola.getBI().getHeight());
    ...
    public void paint(Graphics g) {
        ...
        if (emCima || this.isFocusOwner()) {
            ...
            Ellipse2D ellipse = new Ellipse2D.Float(2, 2,
                    getDiametro() - 4, getDiametro() - 4);
            if (isFocusOwner()) {
    ...
    public void realizaTamanho() {
        setSize(getDiametro(), getDiametro());
    }
